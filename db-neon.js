...
async function loadStateFromBackend() {
  try {
    console.log('Loading state from Neon database...');
    ...
    console.log('State loaded from Neon database successfully');
    return state;
  } catch (error) {
    console.error('Failed to load state from Neon database:', error);
...
async function persistToBackend() {
  try {
    console.log('Persisting state to Neon database...');
    ...
    console.log('State persisted to Neon database successfully');
  } catch (error) {
    console.error('Failed to persist state to Neon database:', error);
    throw error;
  }
}
