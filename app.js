...
// دالة الإشعارات
function showNotification(message, type = 'info') { // type can be 'success', 'warning', 'error', or 'info'
    ...
    notification.className = `notification ${type}`; // This will apply both .notification and .success/error etc.
    ...
    notification.innerHTML = `
        ...
        <p style="flex-grow: 1; margin: 0;">${message}</p>
        <button onclick="this.parentElement.remove()" style="background:none;border:none;color:inherit;font-size:1.5rem;cursor:pointer;opacity:0.7;">&times;</button>
    `;
    notification.style.display = 'flex';
    notification.style.alignItems = 'center';
    notification.style.gap = 'var(--space-4)';
...
function showModal(title, content, onSave) {
    ...
    modalOverlay.style = 'position:fixed;top:0;left:0;width:100%;height:100%;background:var(--bg-overlay);display:flex;align-items:center;justify-content:center;z-index:1000;';
    
    // Use the .card class for the modal itself
